...
using MLKit.Core;
using QRCodeScanner.Core;
using UIKit;

namespace QRCodeScanner.Maui.Platforms.iOS
{
    public class CaptureVideoDelegate : AVCaptureVideoDataOutputSampleBufferDelegate
    {
        ...
        public CaptureVideoDelegate(ICameraView cameraView)
        {
            ...
            var options = new BarcodeScannerOptions(QRCodeScanner.Core.Configuration.BarcodeDetectorSupportFormat);
