        ...
        public static List<BarcodeResult>? ProcessBarcodeResult(Java.Lang.Object result)
        {
            ...
            foreach (var barcode in javaList.ToArray())
            {
                ...
                resultList.Add(new BarcodeResult()
                {
                    ...
                    BoundingBox = new Microsoft.Maui.Graphics.Rect((double)mapped.BoundingBox.Left, (double)mapped.BoundingBox.Top, (double)mapped.BoundingBox.Right, (double)mapped.BoundingBox.Bottom)
                });
            }
