    ...
    public class Methods
    {
        ...
        public static BarcodeResult ProcessBarcodeResult(Barcode barcode)
        {
            return new BarcodeResult
            {
                ...
                BoundingBox = new Microsoft.Maui.Graphics.Rect((double)barcode.Frame.Left, (double)barcode.Frame.Top, (double)barcode.Frame.Right, (double)barcode.Frame.Bottom)
            };
        }
        #endregion
    }
